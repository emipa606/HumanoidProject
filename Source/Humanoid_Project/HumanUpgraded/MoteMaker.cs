...
namespace HumanUpgraded
{
	...
	public static class MoteMaker
	{
		...
		public static void ThrowUpgradedMicroSparks(Vector3 loc, Map map)
		{
			...
			MoteThrown moteThrown = (MoteThrown)ThingMaker.MakeThing(ThingDefOf.Sparks_GreenLightning, null);
		...
		public static void ThrowUpgradedLightningGlow(Vector3 loc, Map map, float size)
		{
			...
			MoteThrown moteThrown = (MoteThrown)ThingMaker.MakeThing(ThingDefOf.AbilityGreenGlow, null);
		...
		public static void ThrowUpgradedSmoke(Vector3 loc, Map map, float size)
		{
			...
			MoteThrown moteThrown = (MoteThrown)ThingMaker.MakeThing(ThingDefOf.Mote_GreenSmoke, null);
